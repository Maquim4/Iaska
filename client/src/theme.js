...
const variantOutlined = () => ({
  field: {
    _focus: {
      borderColor: "var(--chakra-ui-focus-prim-color)",
      boxShadow: "0 0 0 2px var(--chakra-ui-focus-prim-color)"
    }
  }
});
...
export const theme = extendTheme({
  ...
  styles: {
    global: {
      ...
      // html: {
      ":host,:root": {
        "--chakra-ui-focus-prim-color": "#f9d094"
      }
    }
  },
  shadows: {
    ...
    outline: "0 0 0 0px var(--chakra-ui-focus-prim-color)"
  },
  components: {
    Input: {
      variants: {

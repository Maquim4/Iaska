...
const MyChats = ({ fetchAgain }) => {
  ...
  const { selectedChat, setSelectedChat, user, chats, setChats, setPanel } =
    ChatState()
  ...
  useEffect(() => {
    setLoggedUser(JSON.parse(localStorage.getItem('iaskaUser')))
    fetchChats()
  }, [fetchAgain])
  ...
  return (
    ...
    >
      <Box
        ...
        alignItems="center"
      >
        <Button variant="transparent" onClick={() => setPanel('')}>
          <Text color={'#f9d094'} fontSize="2xl">
            My Chats
          </Text>
        </Button>
        <GroupChatModal>
